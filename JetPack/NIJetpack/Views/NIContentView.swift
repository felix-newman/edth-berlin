            ...
            NavigationView {
                VStack(spacing: 50) {
                    NavigationLink(destination: NICameraAssistanceView(mode: .exhibit)) {
                        Text("\(Image(systemName: "paintbrush")) Go to next Friend or Foe.")
                        .padding()
                        .font(.title2)
                        .cornerRadius(10)
                    }
                    if #available(iOS 17.0, watchOS 10.0, *), NISession.deviceCapabilities.supportsExtendedDistanceMeasurement {
                        NavigationLink(destination: NICameraAssistanceView(mode: .visitor)) {
                            Text("\(Image(systemName: "person.2")) Discuss jetpacks with your troops.")
                            .padding()
                            .font(.title2)
                            .cornerRadius(10)
                        }
                ...
                .navigationTitle("Jetpack Friend or Foe")
            }
        }
    }
}
