...
extension FindingMode {
    func moveMessage() -> String {
        switch self {
        case .exhibit: "Move your phone up and down to see friends location."
        case .visitor: "Move your phone up and down to find other friendly Reconaissance."
        }
    }

    func guidanceWhenNoDistance() -> String {
        switch self {
        case .exhibit: "Finding Friends…"
    ...
    func guidanceWhenInGoodMeasurement() -> String {
        switch self {
        case .exhibit: "Find a Friend."
        case .visitor: "Look for friendly Reconaissance"
        }
    }
